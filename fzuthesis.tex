...
% 为每个参考文献条目添加不分页保护
\preto\bibitem{\par\penalty10000\relax}
...
\begin{document}
	...
	\include{Contents/chapter01}%第一章
	\include{Contents/chapter02}%第二章
	\include{Contents/chapter03}%第三章
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\include{Contents/conclusion} %结论
...
% 	\include{appendix}
	...
	\include{Contents/acknowledge} %致谢
    \include{Contents/CV} %简历
    \include{Contents/publications} %成果
   % \include{Contents/pub} %成果
\end{document}
